package slotmechine.strongman.com.slotmechine;
...
public class MainActivity extends ActionBarActivity {
    ...
    private final int SPIN_TIME = 9500;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				wheelView1.scroll(40000 + ( 100 * randomMultipler), SPIN_TIME);
				
				randomMultipler = random.nextInt(9);
				wheelView2.scroll(40000 + ( 100 * randomMultipler), SPIN_TIME);
				
				randomMultipler = random.nextInt(9);
				wheelView3.scroll(40000 + ( 100 * randomMultipler), SPIN_TIME);
